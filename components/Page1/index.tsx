...
export default function Page1(): JSX.Element {
  return (
    ...
    >
      ...
      >
        I build apps(web + mobile) and Unity games.
      </Text>
      ...
      <Text
        ...
        maxW="31.25rem"
      >
        I am a Software engineer proficient in all phases of the
        Software development lifecycle. I am adept at working with different methodologies to accomplish project milestones according to
